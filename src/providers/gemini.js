...
const callGemini = async (messages, context, apiKey) => {
    ...
    const timeoutId = setTimeout(() => controller.abort(), 60000); // 60s timeout for complex context
